...
class Acutum_Adaptive(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(Acutum_Adaptive, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(Acutum_Adaptive, self).__setstate__(state)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                exp_avg_sq.mul_(beta2).addcmul_(1 - beta2, exp_avg, exp_avg)
